...
const char *enumToString(StyleType e);
const char *enumToString(VideoDisplayMode e);
...
void stringToEnum(const std::string &str, StyleType &e);
void stringToEnum(const std::string &str, VideoDisplayMode &e);
